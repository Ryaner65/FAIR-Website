...
<html lang="en">
    <head>
        ...
        <title>FAIR Schulungszentrum</title>
        <!-- Favicon-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">						
                        ...
                        <!--<li class="nav-item"><a class="nav-link" href="foerderung.php">Förderung</a></li>-->
						<lic class="nav-item"><a class="nav-link" href="massnahmen.php">Bildungsangebote</a></li>
